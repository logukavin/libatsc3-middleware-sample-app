...
public class MfuByteBufferHandler {
    ...
    private static void addVideoFragment(MfuByteBufferFragment mfuByteBufferFragment) {
...
//            }
    ...
    private static void addAudioFragment(MfuByteBufferFragment mfuByteBufferFragment) {
...
//            }
    ...
    private static void addSubtitleFragment(MfuByteBufferFragment mfuByteBufferFragment) {
        if(!ATSC3PlayerFlags.FirstMfuBufferVideoKeyframeSent) {
            return;
        }
    ...
    public static void clearQueues() {
        ...
        ATSC3PlayerMMTFragments.mfuBufferQueueStpp.clear();
    }
}
