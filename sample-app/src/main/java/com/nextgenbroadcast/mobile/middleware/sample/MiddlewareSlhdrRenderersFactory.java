...
//extends SlhdrRenderersFactory
/**
 * Default {@link RenderersFactory} implementation.
 */
public class MiddlewareSlhdrRenderersFactory extends SlhdrRenderersFactory implements RenderersFactory {
...
//
//    public MiddlewareSlhdrRenderersFactory(Context var1) {
//        //SlhdrRenderersFactory(var1, var2);
////        super(var1, var2);
//        this.context = var1;
...
//    }
    ...
    public MiddlewareSlhdrRenderersFactory(Context var1, @Nullable ISlhdrMediaCodecConstructed var2) {
        //SlhdrRenderersFactory(var1, var2);
        super(var1, var2);
        this.context = var1;
        extensionRendererMode = EXTENSION_RENDERER_MODE_ON; //jjustman-2020-08-25 - enable this for DAA?
   ...
   */
  public MiddlewareSlhdrRenderersFactory setExtensionRendererMode(
   ...
   * @return This factory, for convenience.
   */
  public MiddlewareSlhdrRenderersFactory setPlayClearSamplesWithoutKeys(
   ...
   * @return This factory, for convenience.
   */
  public MiddlewareSlhdrRenderersFactory setEnableDecoderFallback(boolean enableDecoderFallback) {
   ...
   * @return This factory, for convenience.
   */
  public MiddlewareSlhdrRenderersFactory setMediaCodecSelector(MediaCodecSelector mediaCodecSelector) {
   ...
   * @return This factory, for convenience.
   */
  public MiddlewareSlhdrRenderersFactory setAllowedVideoJoiningTimeMs(long allowedVideoJoiningTimeMs) {
  ...
  public Renderer[] createRenderers(
    ...
    if (drmSessionManager == null) {
      ...
      //call our super Slhdr1.createRenderers()

      Renderer[] superRendererList = super.createRenderers(eventHandler, videoRendererEventListener, audioRendererEventListener, textRendererOutput, metadataRendererOutput, drmSessionManager);
      renderersList.addAll(Arrays.asList(superRendererList));
