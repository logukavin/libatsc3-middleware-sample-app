...
public class SlhdrMMTRenderersFactory extends MMTRenderersFactory {
    ...
    public SlhdrMMTRenderersFactory(Context context, @Nullable ISlhdrMediaCodecConstructed slhdrMediaCodecConstructed) {
        super(context);
