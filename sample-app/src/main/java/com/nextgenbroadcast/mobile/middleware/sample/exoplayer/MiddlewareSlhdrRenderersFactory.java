...
public class MiddlewareSlhdrRenderersFactory extends SlhdrRenderersFactory {
  private static final String TAG = MiddlewareSlhdrRenderersFactory.class.getSimpleName();


  public MiddlewareSlhdrRenderersFactory(Context context, @Nullable ISlhdrMediaCodecConstructed slhdrMediaCodecConstructed) {
    super(context, slhdrMediaCodecConstructed);
