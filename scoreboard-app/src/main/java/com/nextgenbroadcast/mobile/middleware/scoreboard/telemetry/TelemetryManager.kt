...
//            )
    ...
    companion object {
        ...
        private const val AWSIOT_MANAGER_TEMPLATE_NAME = "libatsc3_manager_provisioning"


        private const val AWSIOT_MANAGER_ID_FORMAT = "ngbp_mobile_manager_${AWSIoThing.AWSIOT_FORMAT_SERIAL}"
        ...
        private const val AWSIOT_COMMAND_SINGLE_DEVICE = "control/ngbp_mobile_receiver_${AWSIoThing.AWSIOT_FORMAT_SERIAL}"
